...
Insert Into AddNewBook (BookName,ISBN,PublishDate,Category,Quantity,AuthorName) Values ('C++','123', '12/12/2021','Coding',10, 'Amsterdam');
...
DELETE FROM IssueBook;
insert into IssueBook(UserID, ISBN, IssueDate, ReturnDate, IsReturned, Fine) values ('78', '123', '12/12/2024', '15/12/2024', 0, 900)
